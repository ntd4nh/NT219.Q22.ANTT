...
$networks = @(
    ...
    @{ name = "shopflow_private"; description = "Private subnet (Kong, microservices, Redis, Vault, Keycloak)" },
    @{ name = "shopflow_data";    description = "Data zone (app-db + order-service, isolated from other zones)" }
)
